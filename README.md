...
| <a name="input_autoscaling_read_enabled"></a> [autoscaling\_read\_enabled](#input\_autoscaling\_read\_enabled) | Whether or not to enable autoscaling for table read. | `bool` | `false` | no |
...
| <a name="input_autoscaling_write_enabled"></a> [autoscaling\_write\_enabled](#input\_autoscaling\_write\_enabled) | Whether or not to enable autoscaling for table writes. | `bool` | `false` | no |
...
| <a name="input_index_read_policy_name"></a> [index\_read\_policy\_name](#input\_index\_read\_policy\_name) | Name of the index read autoscaling policy | `string` | `null` | no |
| <a name="input_index_write_policy_name"></a> [index\_write\_policy\_name](#input\_index\_write\_policy\_name) | Name of the index write autoscaling policy | `string` | `null` | no |
...
| <a name="input_read_max_capacity"></a> [read\_max\_capacity](#input\_read\_max\_capacity) | The max number of read units for this table. If the billing\_mode is PROVISIONED, this field should be greater than 0 | `number` | `null` | no |
...
| <a name="input_table_read_policy_name"></a> [table\_read\_policy\_name](#input\_table\_read\_policy\_name) | Name of the read autoscaling policy | `string` | `null` | no |
| <a name="input_table_write_policy_name"></a> [table\_write\_policy\_name](#input\_table\_write\_policy\_name) | Name of the write autoscaling policy | `string` | `null` | no |
...
| <a name="input_write_max_capacity"></a> [write\_max\_capacity](#input\_write\_max\_capacity) | The max number of write units for this table. If the billing\_mode is PROVISIONED, this field should be greater than 0 | `number` | `null` | no |
